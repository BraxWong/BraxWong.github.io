...
export default function Footer() {
    return (
        <footer className={`${styles.color} flex flex-col dark:bg-gray-900 p-4 mt-auto`}>
            <div className="mx-auto w-full max-w-screen-xl p-2 py-4 lg:py-6">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 Brax Wong. All Rights Reserved.</span>
                    <div className="flex mt-2 sm:justify-center sm:mt-0">
                        <a href="mailto:wongbrax@gmail.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                            <svg 
                                className="w-4 h-4" 
                                aria-hidden="true" 
                                ...
                                viewBox="0 0 24 24"
                            >
                                <path d="M12 13.5l-8.5-6h17L12 13.5zm0 2.25l8.5-6v9.75H3.5V9.75L12 15.75zm0-15C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 1z" />
                            </svg>
